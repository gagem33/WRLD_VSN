...
useEffect(() => {
  ...
  const newsIconLayer = new IconLayer({
    id: 'breaking-news',
    data: breakingNews,
    getPosition: d => d.coordinates,
    getIcon: d => ({
        ...
        <div className="space-y-2">
          ...
          <label className="flex items-center space-x-2 cursor-pointer">
            <input
              type="checkbox"
              checked={marketLayer}
              onChange={(e) => setMarketLayer(e.target.checked)}
              className="w-4 h-4"
            />
          ...
          >
            <div className="p-6">
              ...
              <div className={`inline-flex items-center px-3 py-1 rounded-full text-sm mb-4 ${
                ...
                {selectedLocation.sentiment.toUpperCase()}
              </div>
              ...
              <div className="space-y-4">
                <div className="border-b border-gray-700">
                  <div className="flex space-x-4">
                    <button className="pb-2 border-b-2 border-blue-500 text-blue-500">News</button>
                    <button className="pb-2 text-gray-400 hover:text-white">Social</button>
                    <button className="pb-2 text-gray-400 hover:text-white">Markets</button>
                    <button className="pb-2 text-gray-400 hover:text-white">Macro</button>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  <div className="bg-gray-700/50 p-3 rounded">
                    ...
                    <div className="text-sm text-gray-300">
                      Real-time news and market data will appear here
                    </div>
                  </div>
                </div>
              </div>
